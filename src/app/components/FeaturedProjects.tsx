  ...
  const projects = [
    {
      ...
      desc:
        "Plataforma de e-commerce com recomendação de produtos via ML, Next.js e integração com Stripe. Lighthouse score 99.",
    ...
    },
    {
      ...
      desc:
        "Pipeline serverless com AWS Lambda, ECS e GitHub Actions. Deploy 80% mais rápido.",
    ...
    },
    {
      ...
      desc:
        "Aplicativo de produtividade com colaboração em tempo real, Redis para cache e offline-first.",
